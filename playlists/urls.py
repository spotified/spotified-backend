...
urlpatterns = [
    ...
    path("<int:playlist_id>/tracks/", views.PlaylistTrackView.as_view(), name="playlist_track"),
    path("<int:playlist_id>/tags/", views.PlaylistTagsView.as_view(), name="playlist_tags"),
    path("<int:playlist_id>/tags/<int:tag_id>/", views.PlaylistTagsView.as_view(), name="playlist_tag"),
    re_path(
